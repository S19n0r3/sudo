...
This mechanism has been integrated into Bitcore-Node-Sudo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptosudo/insight-api-sudo#web-socket-api](https://github.com/cryptosudo/insight-api-sudo#web-socket-api)
* API: [https://github.com/cryptosudo/insight-api-sudo#instantsend-transactions](https://github.com/cryptosudo/insight-api-sudo#instantsend-transactions)
...
By default, the Sudo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sudo Core daemon:
