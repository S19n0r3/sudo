    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        licenseInfoHTML.replace(uri, "<a style=\"color: #6dc137;\" href=\"\\1\">\\1</a>");
        ...
        QString header = tr("Usage:") + "\n" +
            "  sudo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sudo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SUDO, 0.1 SUDO, 1 SUDO and 10 SUDO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cryptosudo.atlassian.net/wiki/display/DOC/PrivateSend\" style=\"color: #6dc137; text-decoration: none;\" >https://cryptosudo.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
