    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("SUDO CORE");
    QString versionText     = QString(tr("Version %1")).arg(QString::fromStdString(FormatFullVersion()));
    //QString copyrightText   = QString::fromUtf8(CopyrightHolders("\xc2\xA9", 2014, COPYRIGHT_YEAR).c_str());
    QString copyrightText   = QChar(0xA9)+QString(" 2017-2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The Sudo Core Developers"));
    ...
    pixPaint.setPen(QColor(207,207,207));
    ...
    if(!titleAddText.isEmpty()) {
        ...
        pixPaint.drawText(pixmap.width()-titleAddTextWidth-10,pixmap.height()-24,titleAddText);
    }
...
static void InitMessage(SplashScreen *splash, const std::string &message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(108,192,63)));
}
