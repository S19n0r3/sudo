...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Sudo related functionality
...
/*
    ...
    allow endless transaction that would bloat Sudo and make it unusable. To
