...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Sudo address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "sudo",               "masternode",             &masternode,             true,  {} },
    { "sudo",               "masternodelist",         &masternodelist,         true,  {} },
    { "sudo",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "sudo",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "sudo",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "sudo",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
